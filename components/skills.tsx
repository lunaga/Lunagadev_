...
export function Skills() {
  ...
  return (
    <section id="skills" className="py-16 sm:py-20 md:py-32 bg-secondary/30">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {skillCategories.map((category, categoryIndex) => (
              <Card
                key={categoryIndex}
                className="p-5 sm:p-6 bg-card border-border hover:border-primary/50 transition-all duration-300 animate-in fade-in slide-in-from-bottom"
                style={{ animationDelay: `${categoryIndex * 150}ms` }}
              >
                <h3 className="text-xl sm:text-2xl font-bold mb-5 sm:mb-6 text-primary">{category.category}</h3>
